...
void Hooks::Init() {
	...
	// Signatures
	{
		...
		void* chestTick = reinterpret_cast<void*>(FindSignature("40 53 57 48 83 EC ?? 48 8B 41 ?? 48 8B FA 48 89 6C 24 ?? 48 8B D9 4C 89 74 24 ?? 48 85 C0"));
...
#ifdef _DEBUG
					static std::string version = "B 0.4.11";
#elif defined _BETA
